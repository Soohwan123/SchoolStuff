...
namespace ExerciseTests
{
    public class LinqTests
    {
        ...
        public async Task Test7()
        {
            ...
            Student selectedStudent = await _db.Students.FirstOrDefaultAsync(stu => stu.Id == 8006);

            if (selectedStudent != null)
            {
                string currentEmail = selectedStudent.Email;
                string newEmail = currentEmail == "sk@sc.com" ? "sc@sc.com" : "sk@sc.com";  //if currentPhoneNo is "519-555-1234" -> change to "555-555-5555", otherwise change to "519-555-1234" 
